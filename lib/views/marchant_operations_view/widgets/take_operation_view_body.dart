...
import 'package:haf_calc/views/marchant_operations_view/widgets/custom_app_bar_takes_operation.dart';
import 'package:intl/intl.dart';
import '../../../cubits/transactions/transactions_cubit.dart';
import '../marchant_operations_view.dart';
import 'default_text_form_field.dart';

class TakeOperationViewBody extends StatelessWidget {
  TakeOperationViewBody({super.key,required this.merchantId,required this.merchantName});
...
final String merchantName;
  ...
  Widget build(BuildContext context) {
    return Column(
      ...
      children: [
        CustomAppBarTakesOperation(merchantName: merchantName,),
                            ...
                            MaterialButton(
                              ...
                              onPressed: () {
                                if(formKey.currentState!.validate())
                                  {
                                    cubit.addTransaction(-double.parse(amount.text), details.text,datePicked.text,"", merchantId);
                                    Navigator.pushReplacement(context, MaterialPageRoute(builder: (context)=>MarchantOperationsView(merchantName:merchantName,merchantId: merchantId)));
                                  }
                              },
